source(program='AME',version= 9.0,edition=standard,date='Mon Feb 04 23:30:49 GMT 2008').

roots([node00002,node00003,node00004]).

properties([complete-true,file_name-'C:/Inetpub/wwwroot/www/examples/catalogue/models/bob/assoc_from_data2/assoc_from_data2.sml',name-assoc_from_data2]).
