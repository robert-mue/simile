source(program='AME',version= 9.0,edition=standard,date='Tue Feb 05 17:09:16 GMT 2008').
...
properties([complete-true,file_name-'C:/Dad/Projects/NUANCES/century gc weekly.sml',name-'century gc weekly v40']).
...
node(node00044,function,[],[complete=true,name=fn23,units=1,value= 0.094 *exp( -3.0*'StructLignin')*'TempMod'],[]).
...
node(node00048,function,[],[complete=true,name=fn25,units=1,value= 0.35 *'TempMod'],[]).
...
node(node00055,compartment,[],[complete=true,name='Active Soil C'],[caption_offset=[38,-53],centre=[355,487]]).
...
node(node00074,variable,[],[comment='Respa = 0.85 - 0.68*Clay',complete=true,name='Respa'],[caption_offset=[16,-3],centre=[449,581]]).
node(node00075,function,[],[complete=true,name=fn42,units=1,value= 0.85 - 0.68 *'Clay'],[]).
node(node00076,variable,[],[comment='UtilEffas = (1-Respa-0.004)',complete=true,name='UtilEffas'],[caption_offset=[0,0],centre=[391,553]]).
...
node(node00079,function,[],[complete=true,name=fn44,units=1,value= 0.14 *(1- 0.75 *'Clay')*'TempMod'],[]).
...
node(node00094,function,[],[complete=true,name=fn54,units=1,value= 0.00013 *'TempMod'],[]).
...
node(node00102,function,[],[complete=true,name=fn58,units=1,value= 0.0038 *'TempMod'],[]).
...
node(node00223,variable,[],[complete=true,name='and change the array dimension '],[caption_offset=[-26,-166],centre=[-134,2]]).
...
node(node00227,border,[],[name=var3],[centre=[-42,84]]).
node(node00228,border,[],[name=var4],[centre=[78,64]]).
...
arc(arc00045,node00055,node00057,flow,[comment='FCO2a = Active_Soil_C*ka*Respa',complete=true,name='FCO2a'],[caption_offset=[0,0],curve=[550,497]]).
...
arc(arc00073,node00055,node00064,influence,[complete=true,name=i63,role=[use(none,in_hierarchy,'Active_Soil_C',1)]],[curve=[0,-17]]).
arc(arc00048,node00065,arc00047,influence,[name=i42],[]).
arc(arc00074,node00055,node00065,influence,[complete=true,name=i64,role=[use(none,in_hierarchy,'Active_Soil_C',1)]],[curve=[9,14]]).
...
arc(arc00248,node00074,node00064,influence,[complete=true,name=i48_0,role=[use(none,in_hierarchy,'Respa',1)]],[curve=[18,-26]]).
...
arc(arc00067,node00076,node00065,influence,[complete=true,name=i57,role=[use(none,in_hierarchy,'UtilEffas',1)]],[curve=[20,8]]).
arc(arc00064,node00077,node00076,influence,[name=i54],[]).
arc(arc00068,node00074,node00077,influence,[complete=true,name=i58,role=[use(none,in_hierarchy,'Respa',1)]],[curve=[7,-3]]).
...
arc(arc00290,arc00047,node00148,influence,[complete=true,name=i87_0,role=[use(none,in_hierarchy,'Fas',1)]],[curve=[-38,-42]]).
arc(arc00291,node00076,node00148,influence,[complete=true,name=i88_0,role=[use(none,in_hierarchy,'UtilEffas',1)]],[curve=[-4,-26]]).
...
arc(arc00236,arc00075,node00160,influence,[complete=true,name=i37_0,role=[use(none,in_hierarchy,'Fsta',1)]],[curve=[-48,-94]]).
...
arc(arc00258,node00057,node00176,influence,[complete=true,name=i58_0,role=[use(none,in_hierarchy,'CO2_a',1)]],[curve=[-123,36]]).
...
arc(arc00327,node00107,node00186,influence,[complete=true,name=i14_2],[curve=[-250,144]]).
arc(arc00329,node00186,node00050,influence,[complete=true,name=i16_1,role=[use(none,in_hierarchy,yInterpolated,1)]],[curve=[-12,16]]).
...
arc(arc00326,node00227,node00194,influence,[complete=true,name=i13,role=[use(none,in_hierarchy,'Temperature',int)]],[curve=[-82,194]]).
arc(arc00328,node00211,node00228,influence,[complete=true,name=i15_1],[curve=[-54,-18]]).
