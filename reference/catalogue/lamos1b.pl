source(program='AME',version=7.1,edition=enterprise,date='Wed Jun 25 14:27:51 GMT Daylight Time 2003').
...
properties([complete-true,file_name-'C:/Inetpub/wwwroot/www/examples/catalogue/models/bob/lamos1/lamos1b.sml',name-'Desktop',separate-0]).
...
node(node00056,submodel,[node00011,node00030,node00034,node00050,node00054,node00058,node00059,node00060,node00061,node00062,node00063,node00078,node00081,node00082,node00083,node00088,node00095,node00097,node00109,node00122,node00125,node00130,node00246,node00247,node00249,node00250,node00251,node00252,node00253,node00256],[complete=true,fill_colour='#ffdfff',fix_math_args=0,multiplication_spec=[count=[1600]],name=patch,separate=0],[bounding_box=[-27.772930445560007,-54.553970518799986,345.1341984179999,348.15352094450014],caption_offset=[21.82158820727,-4.959451865300004],hide_contents=0,internal_extent=[-14.878355595860068,6.943232611299725,358.0287732677001,409.65072407460013]]).
...
node(node00054,function,[],[complete=true,name=fn1,units=int,value=floor((index(1)-1)/40)+1],[]).
...
node(node00063,function,[],[complete=true,name=fn2,units=1,value=fmod(index(1)-1,40)+1],[]).
...
node(node00139,function,[],[complete=true,name=fn6,units=int,value=40],[]).
...
node(node00141,function,[],[complete=true,name=fn7,units=int,value=40],[]).
