...
node(node00003,variable,[],[complete=true,name='change\nto\nforest'],[bounding_box=[103.91261171780158,248.77457795500038,117.91261171780158,262.7745779550004],caption_offset=[2.997020854000013,12.987090367000121]]).
...
node(node00027,function,[],[complete=true,name=fn11,units=1,value=fmod(index(1)-1,40)+1],[]).

node(node00028,variable,[],[complete=true,name='change\nto\ncrop'],[bounding_box=[93.92254220480153,73.94836147019959,107.92254220480153,87.94836147019959],caption_offset=[34.965243298000146,-39.96027805352021]]).
...
node(node00031,function,[],[complete=true,name=fn13,units=1,value=floor((index(1)-1)/40)+1],[]).
...
node(node00048,variable,[],[complete=true,name='crop\nneighbour'],[bounding_box=[63.91329422466,116.50641796260001,77.91329422465999,130.5064179626],caption_offset=[2.9970208540999934,12.987090367000036]]).
...
arc(arc00006,node00016,node00010,flow,[complete=true,name=growth],[bowtie=[128.48957298900004,23.999006951299997,140.48957298900004,47.9990069513],caption_offset=[-54.42947169600022,0.2826125838000024],course=[[175,35.9990069513],[93.97914597800006,35.9990069513]]]).
...
arc(arc00010,node00020,node00014,flow,[complete=true,name=increment],[bowtie=[72.01588877899997,53.001986097,84.01588877899997,77.001986097],caption_offset=[-49.14196144800022,-1.8567076110000045],course=[[122.03177755799993,65.001986097],[34,65.001986097]]]).
...
arc(arc00018,node00002,node00042,relation,[complete=true,name=me],[caption_offset=[0.9990069512999966,-11.988083416099997],course=[[21.4289724518,57.202414371],[44.214486225899954,73.10120718550002],[69,57]]]).

arc(arc00019,node00002,node00042,relation,[complete=true,name='my\nneighbour'],[caption_offset=[4.048043175599993,-2.7616558184000155],course=[[21.4289724518,76.202414371],[42.21647232309996,95.10120718550013],[69,82]]]).
