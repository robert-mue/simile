source(program='AME',version= 9.0,edition=standard,date='Wed Feb 06 16:59:03 GMT 2008').
...
properties([complete-true,file_name-'C:/Inetpub/wwwroot/www/examples/catalogue/models/mono1/p038.sml',name-p038,separate-0]).

node(node00002,compartment,[],[comment='Amount of water in lake, KAF (thousand acre-feet) (Don''t blame me! - all I''m doing is re-implementing Ford''s model!)',complete=true,name='water in lake'],[caption_offset=[1,-53],centre=[219,113]]).
...
node(node00015,function,[],[complete=true,name=fn7,units=1,value=39],[]).
node(node00017,variable,[],[comment='thousand acre-feet/year',complete=true,name='sierra gauged runoff'],[caption_offset=[-21,-2],centre=[48,126]]).
...
node(node00021,variable,[],[comment='feet/year',complete=true,name='precipitation rate'],[caption_offset=[-64,-16],centre=[69,49]]).
node(node00022,function,[],[complete=true,name=fn10,units=1,value= 0.667],[]).
node(node00023,variable,[],[comment='feet/year',complete=true,name='evaporation rate'],[caption_offset=[10,2],centre=[356,133]]).
node(node00024,function,[],[complete=true,name=fn11,units=1,value= 3.75],[]).

arc(arc00001,node00003,node00002,influence,[name=i1],[]).
arc(arc00002,node00004,node00002,flow,[comment='thousand acre-feet/year',complete=true,name='flow past\ndiversion points'],[caption_offset=[-89,-55],curve=[550,351]]).
arc(arc00003,node00005,arc00002,influence,[name=i2],[]).
arc(arc00004,node00006,node00002,flow,[comment='thousand acre-feet/year',complete=true,name=precipitation],[caption_offset=[-33,-40],curve=[600,206]]).
arc(arc00005,node00007,arc00004,influence,[name=i3],[]).
arc(arc00006,node00008,node00002,flow,[comment='thousand acre-feet/year',complete=true,name='other in'],[caption_offset=[-37,5],curve=[598,218]]).
arc(arc00007,node00009,arc00006,influence,[name=i4],[]).
arc(arc00008,node00002,node00010,flow,[comment='thousand acre-feet/year',complete=true,name=evaporation],[caption_offset=[9,-35],curve=[598,259]]).
arc(arc00009,node00011,arc00008,influence,[name=i5],[]).
arc(arc00010,node00002,node00012,flow,[comment='thousand acre-feet/year',complete=true,name='other out'],[caption_offset=[-34,10],curve=[595,778]]).
